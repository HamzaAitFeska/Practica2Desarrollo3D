...
public class AudioController : MonoBehaviour
{
    ...
    public AudioSource weaponShootBlue, weaponShootOrange, portalInvalidSurface, pickupObject, pickupObjectLoop, dropObject, buttonClick, checkpointReached, playerDeath;
